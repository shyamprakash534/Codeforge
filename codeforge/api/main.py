...
app = FastAPI(title="CodeForge API", version="1.2.0")
_runs = 0
_successes = 0
...
def _workspace_root() -> str:
    root = os.path.realpath(os.getenv("CODEFORGE_WORKSPACE_ROOT", os.path.join(tempfile.gettempdir(), "codeforge-workspaces")))
...
def _run_workflow(req: RunRequest):
    ...
    try:
        ...
        if temporary:
            # Keep the clone only for the lifetime of the request; Render's filesystem is ephemeral.
            pass
